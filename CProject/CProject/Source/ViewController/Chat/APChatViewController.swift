    ...
    private func insertNewMessage(_ message: Message, isLoadingMore: Bool = false) {
        ...
        self.getResponse(with: message.message ) { json, error in
            if error == nil{
                ...
                self.messagesCollectionView.scrollToLastItem(animated: self.isFirstSetLoaded)
            }
...
extension APChatViewController: InputBarAccessoryViewDelegate {
    ...
    func processInputBar(_ inputBar: InputBarAccessoryView) {
        ...
        inputBar.inputTextView.placeholder = "잠시만요...."
        ...
        DispatchQueue.global(qos: .default).async {
            ...
            DispatchQueue.main.async { [weak self] in
                ...
                inputBar.inputTextView.placeholder = "정적인 새끼에게 메세지 보내기"
    ...
    private func insertMessages(_ data: [Any]) {
        for component in data {
            if let str = component as? String {
                ...
                let message = Message(id: "0000", username: "박준하", message: str, isUser: true, created: currentDate)
